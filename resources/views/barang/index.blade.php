        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{$item->tipe}}</td>
                    <td>
                        <a href='{{url('barang/'.$item->nama.'/edit')}}' class="btn btn-warning btn-sm">Edit</a>
                        <form onsubmit="return confirm('Yakin Ingin Menghapus ?')" class="d-inline" action = "{{ url('barang/'.$item->nama) }}" method="POST">
                            @csrf
                            @method('DELETE')
